...
had an average ridership of [x] in 2016, and spans over 20 miles, going from Rogers Park in the north
side and Roseland in the south side. The Red Line also runs 24 hours a day, making it the most well-travelled 
and available L line to take, but we wanted to know what factors affect the ridership of the Red Line, if any.
`;

const barP = `
The first way we visualized data was through a bar chart. By cycling through the different buttons below, you
can resort the bar chart to see different relationships between ridership and various variables. The x-axis shows
ridership, and the fill of the bar chart is based off a luminance adjusted colormap encoding household median income.
A lighter yellow color implies a higher household median income, and a darker blue color implies a lower household 
median income.The strongest correlation we saw was geographical. In the middle of the line (Loop area up to Wrigley 
  ...
  render() {
    ...
    return (
      <div className="react">
        ...
        <div className = "text">{introP}</div>
        <div className = "text">{barP}</div>
